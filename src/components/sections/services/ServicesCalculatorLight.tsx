...
export const ServicesCalculatorLight = () => {
    ...
    return (
        <section className="py-24 relative overflow-hidden bg-[#05080f]">
            ...
            <div className="absolute bottom-1/4 -left-1/4 w-96 h-96 bg-emerald-500/20 rounded-full blur-[120px] pointer-events-none" />
            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                <div className="text-center mb-16">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-slate-200 shadow-sm text-[10px] font-black uppercase tracking-[0.2em] text-primary mb-6"
                    >
                    ...
                    >
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-primary">от цифровизации</span>
                    </motion.h2>
                </div>
                ...
                <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.5 }}
                        className="lg:col-span-7 space-y-6 lg:space-y-8 bg-[#0d111b] border border-white/5 p-5 sm:p-8 lg:p-12 rounded-[2rem] lg:rounded-[3rem] shadow-xl shadow-black/50"
                    >
                        {/* Vehicle Type Toggle */}
                        <div className="space-y-4">
                            <label className="text-xs font-bold uppercase tracking-widest text-slate-400 ml-1">Тип автотранспорта</label>
                            <div className="flex flex-wrap gap-3 p-1 bg-[#131b2f] border border-white/5 rounded-2xl">
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex-1 flex items-center justify-center gap-3 py-4 px-6 rounded-xl transition-all duration-300 ${isActive
                                                ...
                                                : 'text-slate-400 hover:text-white hover:bg-white/5 border border-transparent hover:border-white/10 shadow-sm'
                                                }`}
                                        >
                    ...
                    >
                        <div className="absolute inset-0 bg-emerald-500/10 blur-[60px] opacity-0 group-hover:opacity-100 transition-opacity duration-700" />

                        <div className="h-full bg-[#0d111b] border border-white/5 rounded-[2rem] lg:rounded-[3rem] p-6 sm:p-8 lg:p-12 flex flex-col justify-between relative z-10 shadow-xl shadow-black/50">
                            <div>
                                <h3 className="text-slate-400 font-bold uppercase text-[10px] tracking-widest mb-4 flex items-center gap-2">
                                    <div className="size-2 rounded-full bg-emerald-500 animate-pulse" /> Эффект за один год
                                </h3>
                                ...
                                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 py-6 border-y border-white/5 mb-6">
                                    <div className="relative size-20 sm:size-24 shrink-0">
                                        <svg viewBox="0 0 36 36" className="size-full -rotate-90 drop-shadow-md">
                                        ...
                                        {chartData.map((d, i) => (
                                            <div key={i} className="flex justify-between sm:justify-start items-center gap-3 group/legend">
                                                <div className="flex items-center gap-2">
                                                    <div className="size-2 rounded-full ring-2 ring-[#0d111b] group-hover/legend:scale-125 transition-transform" style={{ backgroundColor: d.color }}></div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between bg-[#131b2f] rounded-xl px-4 py-3 border border-white/5">
                            ...
                            <div className="mt-12 space-y-6">
                                <button className="w-full bg-primary hover:bg-primary/90 text-white py-5 px-8 rounded-2xl font-black uppercase tracking-widest text-sm transition-all flex items-center justify-center gap-3 shadow-lg shadow-primary/30 group">
                                    Рассчитать детально
